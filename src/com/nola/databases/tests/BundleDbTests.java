...
public class BundleDbTests {
    ...
    public void AddBundleTest(){
        ...
        var bundle1= new Bundle("KK-01", "kakatua bundle 1", new String[]{"CAT12", "BAT12"},2, TimeUtilities.GetCurrentTime());
        var bundle2= new Bundle("KK-02", "kakatua bundle 1", new String[]{"DOG99", "PIG07"}, 2, TimeUtilities.GetCurrentTime());
    ...
    public void AddBundle_fail_due_to_duplicate(){
        ...
        var bundleWithDuplicate = new Bundle("MBA-01", "ma baba ami bundle 1", new String[]{"7890788-(2)", "GIP09"},2, TimeUtilities.GetCurrentTime()) ;
